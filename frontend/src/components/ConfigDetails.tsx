...
export const ConfigDetails: React.FC<ConfigDetailsProps> = React.memo(({
  ...
  const displayFields = [
    ...
    { key: 'Presharedkey', label: 'Pre-Shared Key' },
    { key: 'LocalAddress', label: 'Client IP' },
    { key: 'Mtu', label: 'MTU' },
    { key: 'Reserved', label: 'Reserved' },
    { key: 'Jc', label: 'Junk Count (Jc)' },
    { key: 'Jmin', label: 'Junk Min (Jmin)' },
    { key: 'Jmax', label: 'Junk Max (Jmax)' },
    { key: 'S1', label: 'Init Magic (S1)' },
    { key: 'S2', label: 'Resp Magic (S2)' },
    { key: 'S3', label: 'Cookie Magic (S3)' },
    { key: 'S4', label: 'Transport Magic (S4)' },
    { key: 'H1', label: 'Header 1 (H1)' },
    { key: 'H2', label: 'Header 2 (H2)' },
    { key: 'H3', label: 'Header 3 (H3)' },
    { key: 'H4', label: 'Header 4 (H4)' },
    { key: 'I1', label: 'Init Obfuscation (I1)' },
    { key: 'I2', label: 'Obfuscation 2 (I2)' },
    { key: 'I3', label: 'Obfuscation 3 (I3)' },
    { key: 'I4', label: 'Obfuscation 4 (I4)' },
    { key: 'I5', label: 'Obfuscation 5 (I5)' },
