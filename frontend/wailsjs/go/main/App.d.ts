...
export function AddConnectionOrSubscription(arg1:string,arg2:string):Promise<Record<string, any>>;
...
export function CheckRunningBridgeProcesses():Promise<Record<string, number>>;
...
export function GetSubscriptions():Promise<Array<subscription.Subscription>>;
