...
func (m *MockNetworkRecorder) Stop() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Stop")
}

// Stop indicates an expected call of Stop.
func (mr *MockNetworkRecorderMockRecorder) Stop() *MockNetworkRecorderStopCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Stop", reflect.TypeOf((*MockNetworkRecorder)(nil).Stop))
	return &MockNetworkRecorderStopCall{Call: call}
}

// MockNetworkRecorderStopCall wrap *gomock.Call
type MockNetworkRecorderStopCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockNetworkRecorderStopCall) Return() *MockNetworkRecorderStopCall {
	c.Call = c.Call.Return()
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockNetworkRecorderStopCall) Do(f func()) *MockNetworkRecorderStopCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockNetworkRecorderStopCall) DoAndReturn(f func()) *MockNetworkRecorderStopCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
